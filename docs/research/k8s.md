...
kubebuilder `testdata/project-v4` scaffold at `master`. Sample code in section 13 compiles against
...
## 2. Kubebuilder v4 project layout (go/v4 plugin, verified from `testdata/project-v4`)
...
clustarr/
  ...
  internal/
    ...
    downloadarr/ indexarr/ inventorri/ transcodarr/ subtitlarr/   # service internals (non-k8s logic)
