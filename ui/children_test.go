...
func TestArtistAndAuthorPagesLoadTheirChildrenLazilyAndToggleThem(t *testing.T) {
	...
	require.Contains(t, rows, `data-child="debut" data-kind="album" data-monitored="true" data-hasfile="false"`)
	require.Contains(t, rows, `data-child="post" data-kind="album" data-monitored="true" data-hasfile="true" data-quality="FLAC"`)
	...
	require.Equal(t, http.StatusOK, rec.Code)
	require.Contains(t, rec.Body.String(), `data-child="debut" data-kind="album" data-monitored="false"`)
	...
	require.Contains(t, books, `data-child="dispossessed" data-kind="book" data-monitored="true" data-hasfile="true" data-quality="epub"`)
