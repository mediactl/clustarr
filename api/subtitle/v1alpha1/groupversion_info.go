...
// subtitle.clustarr.io v1alpha1 API group (owner: captionarr).
//
// +kubebuilder:object:generate=true
// +kubebuilder:ac:generate=true
// +kubebuilder:ac:output:package=../../applyconfiguration/subtitle
// +groupName=subtitle.clustarr.io
package v1alpha1
...
var (
	...
	GroupVersion = schema.GroupVersion{Group: "subtitle.clustarr.io", Version: "v1alpha1"}
