...
// DefaultMinimumSeeders mirrors IndexerSpec.minimumSeeders'
// +kubebuilder:default.
const DefaultMinimumSeeders int32 = 1

// MinimumSeedersOrDefault is spec.minimumSeeders; unset means
// DefaultMinimumSeeders, and an explicit 0 admits seederless releases.
func (s IndexerSpec) MinimumSeedersOrDefault() int32 {
	if s.MinimumSeeders == nil {
		return DefaultMinimumSeeders
	}
	return *s.MinimumSeeders
}
