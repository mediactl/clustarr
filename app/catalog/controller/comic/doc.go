...
// app/catalog/controller/series exactly for the Comic -> Issue pair (task
...
// app/catalog/metadata/patch.go's buildAlbumMetadataAC doc comment, which
...
// its manga UUID (app/catalog/metadata/target.go) and its issue listing by
