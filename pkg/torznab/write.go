...
func writeItem(rel Release) wireItemOut {
	...
	emitTyped("artist", stringSynth(rel.Artist))
	emitTyped("album", stringSynth(rel.Album))
	emitTyped("author", stringSynth(rel.Author))
	emitTyped("publisher", stringSynth(rel.Publisher))
